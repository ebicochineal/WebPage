...
var ASM_CONSTS = {
  5335387: () => { e512w3d_mouse_l = false; e512w3d_mouse_m = false; e512w3d_mouse_r = false; e512w3d_mouse_position_x = 0; e512w3d_mouse_position_y = 0; e512w3d_buff = null; e512w3d_canvas = null; e512w3d_ctx = null; e512w3d_keys = Array(128); window.addEventListener("mousemove", (e) => { var rect = e512w3d_canvas.getBoundingClientRect(); e512w3d_mouse_position_x = ((e.clientX - rect.left) / parseFloat(e512w3d_canvas.style.width)) * e512w3d_canvas.width; e512w3d_mouse_position_y = ((e.clientY - rect.top) / parseFloat(e512w3d_canvas.style.height)) * e512w3d_canvas.height; }); window.addEventListener("mousedown", (e) => { if (e.button == 0) { e512w3d_mouse_l = true; } if (e.button == 1) { e512w3d_mouse_m = true; } if (e.button == 2) { e512w3d_mouse_r = true; } }); window.addEventListener("mouseup", (e) => { if (e.button == 0) { e512w3d_mouse_l = false; } if (e.button == 1) { e512w3d_mouse_m = false; } if (e.button == 2) { e512w3d_mouse_r = false; } }); window.addEventListener("mouseleave", (e) => { if (e.button == 0) { e512w3d_mouse_l = false; } if (e.button == 1) { e512w3d_mouse_m = false; } if (e.button == 2) { e512w3d_mouse_r = false; } }); window.addEventListener("touchstart", (e) => { if (e.button == 0) { e512w3d_mouse_l = true; } var rect = e512w3d_canvas.getBoundingClientRect(); e512w3d_mouse_position_x = ((e.clientX - rect.left) / parseFloat(e512w3d_canvas.style.width)) * e512w3d_canvas.width; e512w3d_mouse_position_y = ((e.clientY - rect.top) / parseFloat(e512w3d_canvas.style.height)) * e512w3d_canvas.height; }); window.addEventListener("touchmove", (e) => { if (e.button == 0) { e512w3d_mouse_l = true; } var rect = e512w3d_canvas.getBoundingClientRect(); e512w3d_mouse_position_x = ((e.clientX - rect.left) / parseFloat(e512w3d_canvas.style.width)) * e512w3d_canvas.width; e512w3d_mouse_position_y = ((e.clientY - rect.top) / parseFloat(e512w3d_canvas.style.height)) * e512w3d_canvas.height; }); window.addEventListener("touchend", (e) => { if (e.button == 0) { e512w3d_mouse_l = false; } }); window.addEventListener("keydown", (e) => { if (e.isComposing || e.keyCode >= 128) { return; } e512w3d_keys[e.keyCode] = true; }); window.addEventListener("keyup", (e) => { if (e.isComposing || e.keyCode >= 128) { return; } e512w3d_keys[e.keyCode] = false; }); },  
 5337658: () => { return e512w3d_mouse_position_x },  
 5337690: () => { return e512w3d_mouse_position_y },  
 5337722: () => { return e512w3d_mouse_l },  
 5337745: () => { return e512w3d_mouse_m },  
 5337768: () => { return e512w3d_mouse_r }
};
...
var ___start_em_js = Module['___start_em_js'] = 5334500;
var ___stop_em_js = Module['___stop_em_js'] = 5335387;
